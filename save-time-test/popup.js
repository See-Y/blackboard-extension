...
document.addEventListener("DOMContentLoaded", function() {
    chrome.storage.sync.get(['lectureInfo'], function(res) {
        ...
        for (i in lecturelist) {
            var temp = new Object();
            temp["lecture"] = i
            temp["first_time"] = lecturelist[i].first_date == "None" ? "-" : lecturelist[i].first_date + "_" + lecturelist[i].first_time;
            temp["second_time"] = lecturelist[i].second_date == "None" ? "-" : lecturelist[i].second_date + "_" + lecturelist[i].second_time;
            temp["third_time"] = lecturelist[i].third_date == "None" ? "-" : lecturelist[i].third_date + "_" + lecturelist[i].third_time;
